defmodule Storex.AccountsTest do
  ...
  def user_fixture(attrs \\ %{}) do
    {:ok, user} = attrs |> Enum.into(@valid_attrs) |> Accounts.create_user()
  ...
  describe "accounts_users" do
    ...
    test "create_user/1 creates a user when the data is valid" do
    ...
    test "authenticate_user/2 returns an error when password does not match" do
      user_fixture()
